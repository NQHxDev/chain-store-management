         ...
         <div className="bg-white border-b">
            <div className="max-w-7xl mx-auto px-4 py-8">
               <div className="text-center">
                  <h1 className="text-4xl font-bold text-gray-900 mb-3">Chính sách & Điều khoản</h1>
                  <p className="text-gray-600 max-w-2xl mx-auto">
                     Các quy định và chính sách quan trọng giúp bảo vệ quyền lợi của bạn khi sử dụng
                     dịch vụ ZeionStore
                  </p>
               </div>
            </div>
                     ...
                     <div className="border-b border-gray-200">
                        <div className="px-8 py-6">
                           <div className="flex items-center justify-between">
                              ...
                              <div className="text-sm text-gray-500">ZeionStore • Chính sách</div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="flex items-start gap-4">
                        ...
                        <div>
                           ...
                           <p className="text-sm text-gray-600">
                              ...
                              ngại liên hệ với đội ngũ hỗ trợ qua email
